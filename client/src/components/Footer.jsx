...
//   <>
//     <Box
//       sx={{ py: 3, textAlign: "center", borderTop: "1px solid #ccc", mt: 5 }}
//     >
//       <Typography variant="body2">
//         &copy; {new Date().getFullYear()} Karthick.R All rights reserved.
//       </Typography>
//     </Box>
    
//     <Box sx={{ textAlign: "center", mt: 1 }}>
      
//       <Button href={users.github} target="_blank">
//         <i className="fab fa-github"></i>
//       </Button>
//       <Button href={users.linkedIn} target="_blank">
